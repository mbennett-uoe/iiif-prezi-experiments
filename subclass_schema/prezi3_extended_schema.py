...
#   timestamp: 2021-06-16T15:24:24+00:00
...
from schema_extension_reverse import ManifestExtension, CanvasExtension
...
class ViewingDirection(BaseModel):
    __root__: Union[
...
class AnnoSelectorItem(BaseModel):
    type: str
    t: Optional[Duration] = None


class AnnoSelector(BaseModel):
...
class Collection(Class):
    ...
    items: Optional[List[Union[Manifest, Collection]]] = None
    annotations: Optional[List[AnnotationPage]] = None


class Manifest(Class, ManifestExtension):
...
class Canvas(Class, CanvasExtension):
    type: Optional[constr(regex=r'^Canvas$')] = None
